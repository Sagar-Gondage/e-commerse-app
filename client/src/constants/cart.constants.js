...
export const DELETE_PRODUCT_FROM_API_REQUEST =
  "DELETE_PRODUCT_FROM_API_REQUEST";
export const DELETE_PRODUCT_FROM_API_SUCCESS =
  "DELETE_PRODUCT_FROM_API_SUCCESS";
export const DELETE_PRODUCT_FROM_API_FAIL = "DELETE_PRODUCT_FROM_API_FAIL";
